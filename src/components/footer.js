...
function Footer() {
  ...
  return (
    <>
        {openLinks ?
            <div className='fixed bottom-0 right-0 z-20 w-1/3 md:w-1/5 h-2/5 navbar bg-light-purple bg-opacity-90'>
          ...
          :
            <div className="fixed bottom-0 left-0 z-20 flex flex-row w-full navbar h-14 xl:h-20 3xl:h-32 bg-light-purple bg-opacity-70">
